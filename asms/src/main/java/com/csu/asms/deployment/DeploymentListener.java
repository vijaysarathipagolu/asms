...
public class DeploymentListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent arg0) {
		...
		try {
			...
			Connection c = DriverManager.getConnection(props.getProperty("jdbc.url"), props.getProperty("jdbc.username"), props.getProperty("jdbc.password"));
			...
			try {
		       ...
		       /* if(props.getProperty("dropFirst").trim().equalsIgnoreCase("true"))
	        	liquibase.dropAll();
		        */
