...
public class LoginController {
	...
	/**
	 * this method handles requests when user click on signIn in Home page
	 * 
	 * @param locale
	 * @param model
	 * @return
	...
	/**
	 * this method handles the user login functionality in the login page
	 * 
	 * @param request
	 * @param csuid
	 * @param password
	...
	public ModelAndView login(HttpServletRequest request, @RequestParam Long csuid, @RequestParam String password) {
	...
	/**
	 * this method is handles the user request which user click on Home link in
	 * user dashboard page
	 * 
	 * @param request
	 * @param model
	...
	/**
	 * this method handles requests when admin clicks on Home in admin dashboard
	 * page
	 * 
	 * @param request
	 * @param model
	...
	public String admindashboard(HttpServletRequest request, Model model) {
		...
		if (user != null && user.isAdmin()) {
			System.out
					.println("in admindashboard method to get admin details" + session.getAttribute("user").toString());
	...
	/**
	 * this method handles the user search functionality in user dashboard page
	 * 
	 * @param csuid
	 * @param request
	 * @param model
	...
	/**
	 * this method handles the request to get all the professors
	 * 
	 * @param request
	 * @param model
	 * @return
	...
	/**
	 * This method is used to handle logout from the application
	 * 
	 * @param request
	 * 
	 * @return
